...
require_once $_SERVER["DOCUMENT_ROOT"] . "/controller/researcher/documentList.php";

/**
 * Load device-related research documents
 */
...
$template = $twig->load("./Researcher/Device.twig");
