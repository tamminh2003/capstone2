 ...
 *
 * @method     ChildPoctDeviceAditionalInfoQuery leftJoinUsers($relationAlias = null) Adds a LEFT JOIN clause to the query using the Users relation
 * @method     ChildPoctDeviceAditionalInfoQuery rightJoinUsers($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Users relation
 * @method     ChildPoctDeviceAditionalInfoQuery innerJoinUsers($relationAlias = null) Adds a INNER JOIN clause to the query using the Users relation
 *
 * @method     ChildPoctDeviceAditionalInfoQuery joinWithUsers($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Users relation
 *
 * @method     ChildPoctDeviceAditionalInfoQuery leftJoinWithUsers() Adds a LEFT JOIN clause and with to the query using the Users relation
 * @method     ChildPoctDeviceAditionalInfoQuery rightJoinWithUsers() Adds a RIGHT JOIN clause and with to the query using the Users relation
 * @method     ChildPoctDeviceAditionalInfoQuery innerJoinWithUsers() Adds a INNER JOIN clause and with to the query using the Users relation
 *
...
abstract class PoctDeviceAditionalInfoQuery extends ModelCriteria
{
    ...
    public function filterByUsers($users, $comparison = null)
    {
        if ($users instanceof \Propel\Users) {
            return $this
                ->addUsingAlias(PoctDeviceAditionalInfoTableMap::COL_USER_USER_ID, $users->getUserId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PoctDeviceAditionalInfoTableMap::COL_USER_USER_ID, $users->toKeyValue('PrimaryKey', 'UserId'), $comparison);
        } else {
